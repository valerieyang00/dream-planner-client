...
export default function App() {
  ...
  return (
    <div className={`App ${theme}`}>
      <br></br>
      <br></br>
      <label for="small-toggle" class="inline-flex relative items-right mb-5 cursor-pointer">
        <input type="checkbox" onClick={toggleTheme} id="small-toggle" class="sr-only peer" />
